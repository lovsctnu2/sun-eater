  ...
  return (
    <div className="relative h-screen text-white overflow-hidden">
      ...
      <div className="relative flex flex-col justify-center items-center h-full text-center">
        ...
        <p className="text-xl text-gray-300 mb-8 px-4 sm:px-8 lg:px-24">Today they represent Indonesia’s young talents – from Hindia, .Feast, Reality Club, Agatha Pricilla, Lomba Sihir, <br /> Mantra Vutura, Aldrian Risjad, to Rayhan Noor. </p>
