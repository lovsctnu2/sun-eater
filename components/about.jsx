      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
          ...
          <div className="text-gray-900 md:w-3/5 font-light pt-6 md:pt-10 pl-0 md:pl-10">
            <h2 className="text-xl sm:text-5xl font-bold leading-tight md:mb-5">About</h2>
        ...
        <div className="w-full text-center mt-12 md:mt-16">
          <h2 className="text-4xl sm:text-5xl font-bold">Sun Eater Wheel</h2>
          <Link href="/">
            <Image
              ...
              height={1200}
              alt="sun-eater"
              className="mx-auto w-full max-w-sm sm:max-w-md md:max-w-xl pb-10 md:pb-20"
            />
          </Link>
        </div>
        ...
        <h2 className="text-4xl sm:text-5xl font-bold text-center md:mb-20">Meet Our Team</h2>
